...
public class TestHeapPerformance {
  ...
  public void testRuntime() throws Exception {
    ...
    assertTrue("Heap performance regression - run test individually, since the hotspot optimizations may make the difference! " + htime + " >>= " + pqtime, htime < 1.8 * pqtime);
    // 1.8 allows some difference in measuring
    // NOTE: This test does not run correctly on all machines, so we are being really liberal here
  }
